...
export const STAGE_CONFIG = {
  ...
  stage2: { label: '6进4', desc: '跑图 · 六边形', icon: '02', mapShape: 'hexagon', layers: 3, wallLabels: ['密锁之墙', '准锁之墙'], totalTimeMs: null, turnTimeMs: null, playerCount: 6 },
  stage3: { label: '4进2', desc: '跑图 · 正方形', icon: '03', mapShape: 'square', layers: 3, wallLabels: ['叹息之墙', '终局之墙'], totalTimeMs: null, turnTimeMs: null, playerCount: 4 },
